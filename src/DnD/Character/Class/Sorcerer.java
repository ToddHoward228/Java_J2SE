...
public class Sorcerer extends CharacterClass {
    Sorcerer() {
        ...
        features.add(new Spell("Meteor", "A devastating 9th-level evocation spell that summons four " +
        ...
        features.add(new Spell("Earthquake", "An 8th-level evocation spell that creates a powerful " +
