...
public class BuilderPatternDemo {
    ...
    public static void main(String[] args) {
        ...
        Meal order1 = mealBuilder.prepareVegMeal("Pepsi");

        System.out.println("\tOrder 1");
        System.out.println("Cost = " + order1.getCost());
        order1.showItems();

        Meal order2 = mealBuilder.prepareVegMeal("Coke");

        System.out.println("\tOrder 2");
        System.out.println("Cost = " + order2.getCost());
        order2.showItems();

        Meal order3 = mealBuilder.prepareNonVegMeal("Coke");
        System.out.println("\tOrder 3");
        System.out.println("Cost = " + order3.getCost());
        order3.showItems();

        Meal order4 = mealBuilder.prepareNonVegMeal("Pepsi");
